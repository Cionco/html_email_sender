...
/**
 * This is a BorderLayout without the Center space.
 * That means that some interactions are slightly different but overall it's the same thing as the BorderLayout
 * 
 * @since 1.0
 * 
 * @see java.awt.BorderLayout
 */
public class CenterlessBorderLayout implements LayoutManager2,
                                     java.io.Serializable {
    /**
	 * 
	 */
	private static final long serialVersionUID = 5296754508863681507L;
    ...
    */
   public CenterlessBorderLayout(int hgap, int vgap) {
       this.hgap = hgap;
       this.vgap = vgap;
   }
     ...
     * @since   JDK1.1
     * @return {@link #hgap} of this object
     */
    public int getHgap() {
        return hgap;
    }
     ...
     * @since   JDK1.1
     * @return {@link #vgap} of this object
     */
    public int getVgap() {
        return vgap;
    }
     ...
     * <code>SOUTH</code>, <code>EAST</code> or
     * <code>WEST</code>.
     * <p>
    ...
    public void addLayoutComponent(String name, Component comp) {
      synchronized (comp.getTreeLock()) {
        /* Special case:  treat null the same as "North". */
        if (name == null) {
            name = "North";
        }
     ...
     * <code>CenterlessBorderLayout</code> object. The <code>NORTH</code>
     * and <code>SOUTH</code> components, if any, are placed at
     * the top and bottom of the container, respectively. The
     * <code>WEST</code> and <code>EAST</code> components are
     * then placed on the left and right, respectively. <code>EAST</code>
     * and <code>WEST</code> share the remaining space. 
     * <p>
     * Most applications do not call this method directly. This method
    ...
    public void layoutContainer(Container target) {
      synchronized (target.getTreeLock()) {
        ...
        if ((c=getChild(EAST,ltr)) != null) {
            c.setSize((target.getWidth() - insets.left - insets.right - hgap) / 2, bottom - top);
            Dimension d = new Dimension((target.getWidth() - insets.left - insets.right - hgap) / 2, bottom - top);
            c.setBounds(right - d.width, top, d.width, d.height);
            right -= d.width + hgap;
        }
        if ((c=getChild(WEST,ltr)) != null) {
            c.setSize(target.getWidth() - insets.left - insets.right - hgap, bottom - top);
            Dimension d = new Dimension((target.getWidth() - insets.left - insets.right - hgap) / 2, bottom - top);
     ...
     * 
     * @return component corresponding to the given constraint location
     */
